                        ...
                        <div class="about-item">
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="about-item-inner border p-4">
                                        <div class="about-icon mb-4">
                                            <img src="@/plantilla/img/about-icon-1.png" class="img-fluid w-50 h-50" alt="Icon">
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="about-item-inner border p-4">
                                        <div class="about-icon mb-4">
                                            <img src="@/plantilla/img/about-icon-2.png" class="img-fluid h-50 w-50" alt="Icon">
                                        </div>
            ...
            <div class="container py-5">
                ...
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-lg-12 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                        <img src="@/plantilla/img/features-img.png" class="img-fluid w-100" style="object-fit: cover;" alt="Img">
                    </div>
                    <div class="col-xl-4">
                        <div class="row gy-4 gx-0">
                            <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
