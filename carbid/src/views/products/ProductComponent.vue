   ...
   <div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
        ...
        <div class="container-fluid categories py-5">
            <div class="container py-5">
               ...
               <div class="row">
                        <div class="categories-item col-3 p-4 m-4">
                        <div class="categories-item-inner">
                            <div class="categories-img rounded-top">
                                <img src="@/plantilla/img/car-1.png" class="img-fluid w-100 rounded-top" alt="">
                            </div>
                    ...
                    <div class="categories-item col-3 p-4 m-4">
                        <div class="categories-item-inner">
                            <div class="categories-img rounded-top">
                                <img src="@/plantilla/img/car-2.png" class="img-fluid w-100 rounded-top" alt="">
                            </div>
                            <div class="categories-content rounded-bottom p-4">
                    ...
                    <div class="categories-item col-3 p-4 m-4">
                        <div class="categories-item-inner">
                            <div class="categories-img rounded-top">
                                <img src="@/plantilla/img/car-3.png" class="img-fluid w-100 rounded-top" alt="">
                            </div>
                            <div class="categories-content rounded-bottom p-4">
                    ...
                    <div class="categories-item col-3 p-4 m-4">
                        <div class="categories-item-inner">
                            <div class="categories-img rounded-top">
                                <img src="@/plantilla/img/car-4.png" class="img-fluid w-100 rounded-top" alt="">
                            </div>
                            <div class="categories-content rounded-bottom p-4">
